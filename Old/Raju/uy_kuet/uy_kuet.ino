...
#define rightMotor1 10 // In 2
#define rightMotor2 11 // In 1
//#define rightMotorPWM 11 //En A 
#define leftMotor1 5 // In 3
#define leftMotor2 6 // In 4
...
QTRSensorsAnalog qtra ((unsigned char[]) {A1,A2,A4 } ,NUM_SENSORS, EMITTER_PIN); // sensor connected through analog pins A0 - A5 i.e. digital pins 14-19
