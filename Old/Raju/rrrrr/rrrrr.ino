...
//---------for stop 
 ...
 //---------------------------------------------------         
          ...
          if(digital_sens_reading[0]==line && digital_sens_reading[1]==line && digital_sens_reading[2]==line && stop_method==1  && digital_sens_reading[3]==line && digital_sens_reading[4]==line && digital_sens_reading[5]==line )
                     {
                        for(q=0;q <= 1000; q++)                                                               //----------------------------------//
                            {  
                              motor_full_stop();
