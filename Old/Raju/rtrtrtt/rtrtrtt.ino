...
//-------------------for digital pid
  ...
  int digital_sens[6]={A5,A6,A7,A8,A9,A10}; // 2,13,8 left sens and 9,10,12 right sens
...
//       }
 ...
 //---------------------------------------------
   for(int m=0; m<6; m++) //read digital sensor
        {
         digital_sens_reading[m]= analogRead(digital_sens[m]);
        }
        
       if(digital_sens_reading[0]> 200 || digital_sens_reading[5]> 200)
           {
              //background_black;
...
//---------for stop 
          if(line ==black)
                {
                  black_digital_sens_read_for_pid();
                ...
                }else
                  {
                     ...
                     white_digital_sens_read_for_pid();
                    if(sensors[1] > 200)
                       {
                         stop_method=2; 
                       }else
...
//          if(digital_sens_reading[0]==line && digital_sens_reading[1]==line && digital_sens_reading[2]==line && (stop_method==1 || stop_method==2) && digital_sens_reading[3]==line && digital_sens_reading[4]==line && digital_sens_reading[5]==line )
//                     {
//                        for(q=0;q <= 1000; q++)                                                               //----------------------------------//
//                            {  
//                              motor_full_stop();
...
void white_digital_sens_read_for_pid()
  {
       for(u=0;u<6;u++)
              {
                 digital_sens_reading[u] = analogRead(digital_sens[u]);
                 if(digital_sens_reading[u] < 200)  //1 <200== whhite
                       {
                      ...
                      // Serial.println(digital_sens_reading[u]); 
                       ...
                       white_indicating_digital_LED_For_any_line();
  ...
  void black_digital_sens_read_for_pid()
  {
       for(u=0;u<6;u++)
              {
                 digital_sens_reading[u] = analogRead(digital_sens[u]);
                 if(digital_sens_reading[u] > 200)  //1 >200== Black
                       {
                      ...
                      // Serial.println(digital_sens_reading[u]); 
                       ...
                       black_indicating_digital_LED_For_any_line();
  ...
  void black_indicating_digital_LED_For_any_line()
 {
   
    if(digital_sens_reading[0] > 200)
                         {
...
void white_indicating_digital_LED_For_any_line()
 {
