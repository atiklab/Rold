...
public class menu extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    final ToggleButton light4 = (ToggleButton) findViewById(R.id.ToggleButton05);
	    door.setOnClickListener(new View.OnClickListener() {
	    ...
	    final ToggleButton light5 = (ToggleButton) findViewById(R.id.ToggleButton06);
	    door.setOnClickListener(new View.OnClickListener() {
	    ...
	    final ToggleButton light6 = (ToggleButton) findViewById(R.id.ToggleButton07);
	    door.setOnClickListener(new View.OnClickListener() {
