...
QTRSensorsRC qtrrc((unsigned char[]) {A2, A3, A4, A5},
  NUM_SENSORS, TIMEOUT, EMITTER_PIN); 
QTRSensorsRC qtrrc2((unsigned char[]) {  A0, A7},
  NUM_SENSORS2, TIMEOUT, EMITTER_PIN); 
...
void loop()
{
  ...
  Serial.print('\t');
  Serial.println(position2); // comment this line out if you are using raw values
  SPEED= bspeed;
