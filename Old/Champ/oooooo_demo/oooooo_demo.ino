...
//-------------------for digital pid
  ...
  int digital_sens[4]={A0,A1,A4,A5}; // 2,13,8 left sens and 9,10,12 right sens
  int digital_sens_reading[4];
...
QTRSensorsAnalog qtra ((unsigned char[]) {7,8,A3 } ,NUM_SENSORS, EMITTER_PIN); // sensor connected through analog pins A0 - A5 i.e. digital pins 14-19
