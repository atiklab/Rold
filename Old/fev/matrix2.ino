...
int pauseDelay = 2000;  //microseconds to leave each row  on before moving to the next
...
int rowA[] = {17,16,15,14,13,12,11,10};  //An Array defining which pin each column is attached to
