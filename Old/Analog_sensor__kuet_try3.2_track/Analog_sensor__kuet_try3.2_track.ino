...
for(i=0;i<NUM_SENSORS;i++)
{
  ...
  threshold[i]= minv[i]- correction3 + (maxv[i]-minv[i])/2;
  else
...
else if ((sum==1000)||(sum==1100)||(sum==100)) 
{
 ...
 delay(1000);
  ...
  else if ((sum==110111)||(sum==111011)||(sum==110011)) 
{
  //SPEED=MSPEED-50;
    mway('f');
 }
 else if ((sum==111000)||(sum==110000))//||(sum==111100)||(sum==111110)) 
{
    mway('R');
 }
  else if ((sum==000111)||(sum==000011))//)||(sum==001111)||(sum==011111)) 
{
    mway('L'); 
 }
