...
Ibles.views.Signup = Ibles.views.BaseAuth.extend({
    ...
    submitSignup: function(form) {
        ...
        this.signupAction($form, function(data){
            ...
            robocheck.refresh();
        }, {answer: robocheck.model.get("selectedAnswers").join()});                            
    },
...
Ibles.views.RoboCheckView = Backbone.View.extend({
    ...
    initialize: function(opts) {
        this.template = Ibles.templateCache('#robocheck_template');
    ...
    render: function() {      
        this.$el.html(this.template(_.extend(this.model.toJSON(), {cacheBuster: new Date().getTime() + $.cookie("JSESSIONID")})));
        return this;
    }
});
