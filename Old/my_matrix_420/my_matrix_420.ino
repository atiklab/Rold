...
char requestString[] = " Happy Birthday my * .I love you too much To live without you lOVIZG me back ";  //The string to display
...
//Pin Definitions
int colA[] = {9,8,7,6,5,4,3,2};          //An Array defining which pin each row is attached to
                                         //(rows are common anode (drive HIGH))
int rowA[] = {14,15,16,17,13,12,11,10};  //An Array defining which pin each column is attached to
