...
//Pin Definitions
int rowA[] = { 14,15,16,17,18,19,20,21};          //An Array defining which pin each row is attached to
                                         //(rows are common anode (drive HIGH))
int colA[] = {9,8,7,6,5,4,3,2};  //An Array defining which pin each column is attached to
