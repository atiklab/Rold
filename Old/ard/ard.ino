...
if(int(val)==58)//Turn Light3 ON
   digitalWrite(7,HIGH);

 else if(int(val)==59)//Turn Light3 OFF
       digitalWrite(7,LOW);
       
if(int(val)==60)//Turn Light3 ON
   digitalWrite(8,HIGH);

 else if(int(val)==61)//Turn Light3 OFF
       digitalWrite(8,LOW);
     
if(int(val)==62)//Turn Light3 ON
   digitalWrite(9,HIGH);

 else if(int(val)==63)//Turn Light3 OFF
       digitalWrite(9,LOW);
}
}
